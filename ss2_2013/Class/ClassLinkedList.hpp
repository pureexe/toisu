#ifndef CLASSLINKEDLIST_HPP_INCLUDED
#define CLASSLINKEDLIST_HPP_INCLUDED
#include<iostream>
using namespace std;
    ...
    ***/
    ...
    void push_sort(TYPE b) {
        if(root==NULL)
            ...
            u ->setNext(trav);
            trav->getPrev()->setNext(u);
            u->setPrev(trav->getPrev());
            trav->setPrev(u);
        }
    }
    ~LinkedList() {};
    ...
    /**********************
    Reimplement for support Teacher Requirement
    **********************/
...
#endif // CLASSLINKEDLIST_HPP_INCLUDED
